        ...
        btnDelete.addActionListener( new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                 if ( tfWord.getText().length() > 0 ) {
                       boolean done = WordMeaningBook.deleteWord(tfWord.getText().toLowerCase());
                 ...
                 if (!done)
                      ...
                      JOptionPane.showMessageDialog( DeleteWord.this, "Please enter word from WMBOOK!","Add Word", JOptionPane.ERROR_MESSAGE);
            }
         }
        );
